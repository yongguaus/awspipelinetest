...
class CfnRotationSchedule(
    ...
    def __init__(
        ...
        *,
        ...
        :param rotate_immediately_on_update: ``AWS::SecretsManager::RotationSchedule.RotateImmediatelyOnUpdate``.
    ...
    class RotationRulesProperty:
        def __init__(
            ...
            *,
            ...
            :param duration: ``CfnRotationSchedule.RotationRulesProperty.Duration``.
            :param schedule_expression: ``CfnRotationSchedule.RotationRulesProperty.ScheduleExpression``.
