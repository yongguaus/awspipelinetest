    ...
    class EBSStorageInfoProperty:
        def __init__(
            ...
            *,
            ...
            :param provisioned_throughput: ``CfnCluster.EBSStorageInfoProperty.ProvisionedThroughput``.
    ...
    class ProvisionedThroughputProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param enabled: ``CfnCluster.ProvisionedThroughputProperty.Enabled``.
            :param volume_throughput: ``CfnCluster.ProvisionedThroughputProperty.VolumeThroughput``.
